...
content = content.replace(/venda de fotos de pés/gi, 'venda de fotos do corpo');
content = content.replace(/fetiche por pés/gi, 'venda de conteúdos exclusivos');
content = content.replace(/fotos de pés/gi, 'fotos do corpo');
content = content.replace(/dos seus pés/gi, 'do seu corpo');
